...
export class ProductService {
  ...
  getAllTags(): Tag[] {
    return [
      ...
      { name: "herbs", count: 2 },
      { name: "produce", count: 9 },
      { name: "vegetables", count: 8 },
      { name: "bread", count: 2 },
      { name: "pantry", count: 5 },
      { name: "dressing", count: 1 },
      { name: "milk", count: 3 },
      { name: "non-dairy", count: 2 },
      { name: "plant-based", count: 2 },
      { name: "fruit", count: 2 },
    ...
    return [
      {
        ...
        numOfReviews: 715,
        description:
          "Our H‑E‑B Organic Fresh Basil has about 1/2 CUP Chopped within the package! TIP: Toss fresh basil directly into salads, or chop & add to warm grains to add more herbaceous notes to your next meal!",
        organic: true,
        tags: ["herbs", "produce"],
      },
      {
        ...
        numOfReviews: 645,
        description:
          "Crunchy organic celery, perfect for any soup, sandwich mix, or snack. Celery hearts are what we're used to eating: they're the tender inner ribs of the celery, which have been protected by more bitter, outer stalks. Yes, eating celery just got simpler. Don't forget celery hearts are a good source of vitamin A which promotes skin, eye, and bone health!",
        organic: true,
      ...
      },
      {
        ...
        numOfReviews: 165,
        description:
          "Sweetened with organic fruit juices, Powerseed® has 1g of sugar per slice. It is lightly sweet and power-packed with fiber, protein and whole grain nutrition.",
        organic: true,
        tags: ["bread"],
      },
      {
      ...
      },
      {
        ...
        numOfReviews: 213,
        description:
          "Often referred to as the Pink Navel; Acidity levels are lower on Cara Cara compared to the traditional Navel Oranges",
        organic: false,
        tags: ["fruit", "snack"],
      },
      {
      ...
      },
      {
        ...
        numOfReviews: 475,
        description:
          "Use this fresh organic cilantro for garnishing many of your favorite dishes. Widely used in Mexican, Middle Eastern, Indian and Asian cuisine.",
        organic: true,
      ...
      },
      {
        ...
        numOfReviews: 96,
        description:
          "Seedless Cucumbers are generally sweeter than a regular cucumber, which has large seeds. Great for salads, snacking and dipping",
        organic: false,
        tags: ["vegetables", "produce", "snack"],
      },
      {
      ...
      },
      {
        ...
        numOfReviews: 642,
        description:
          "Thoroughly washed and ready to enjoy, this baby spring mix blend is a handy salad shortcut. Offering a good source of iron, it's certified USDA Organic and Kosher. Just add your favorite toppings and dressing for a gourmet-quality salad in seconds",
        organic: true,
      ...
      {
        productId: 14,
        imageUrl: "/assets/images/game-grass-fed-bison-ribeye-steaks.webp",
        ...
        numOfReviews: 698,
        description:
          "Our bison comes from a ranch in Colorado whose fundamental beliefs are Always be ethical. Always be accountable. Always be dependable. The animals are raised free-range and never administered hormones or antibiotics.  They are grass-fed and finished on both grass and grains.",
        organic: false,
        tags: ["meat"],
      },
      {
      ...
      },
      {
        ...
        numOfReviews: 714,
        description:
          "Grown in Thailand, Golden Star's Jasmine Rice is a naturally fragrant, long grain rice that is known for its slightly sweet taste and soft texture. Jasmine Rice is great with any meal!",
        organic: false,
      ...
      },
      {
        ...
        productName: "Organic Sweet Onions (3 pound bag)",
        price: 1347,
        brand: " Organic Mountain Farms",
        rating: 3.5,
        numOfReviews: 793,
        description:
          "Sweet 'Candy' Onions from Organic Mountain Farms are different because they really are sweet.",
        organic: false,
        tags: ["vegetables", "produce"],
      },
      {
        ...
        numOfReviews: 419,
        description:
          "Delicious any way you crack it. Horizon eggs comes from hens fed an organic, vegetarian diet, with access to the outdoors.",
        organic: true,
      ...
      },
      {
        ...
        numOfReviews: 413,
        description:
          "A good source of fiber and 6 vitamins and minerals. Contains 14 G of total fat per serving. Resealable bag for freshness. Steam pasteurized to maintain quality and safety without cooking. With H‑E‑B Select Ingredients, you'll enjoy foods with carefully chosen ingredients. We never use high fructose corn syrup, artificial flavors and hundreds of other synthetic ingredients that may be used in processed foods. ",
        organic: false,
        tags: ["nuts", "snack"],
      },
      {
      ...
      },
      {
        ...
        numOfReviews: 748,
        description:
          "Rich flavor with a meaty texture. Great for sautéing or grilling. Fresh, never frozen, Wild caught",
        organic: false,
        tags: ["seafood"],
      },
      {
        ...
        numOfReviews: 523,
        description:
          "Cheerios has been a family favorite for years. Its wholesome goodness is perfect for toddlers to adults and everyone in between. Made from whole grain oats, and without artificial flavors or colors, they’re naturally low in fat and cholesterol free. These wholesome little “o’s” have only one gram of sugar!",
        organic: true,
        tags: ["cereal", "snack"],
      },
    ];
